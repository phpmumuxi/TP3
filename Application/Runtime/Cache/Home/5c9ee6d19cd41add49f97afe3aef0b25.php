...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>
                    您好，欢迎来到京西！[<a href="<?php echo U('Home/User/login');?>">登录</a>] [<a href="<?php echo U('Home/User/regist');?>">免费注册</a>]                
                                        </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="<?php echo U('Home/User/index');?>"><img src="/Public/home/images/logo.png" alt="京西商城"></a></h2>
		</div>
	</div>
	<!-- 页面头部 end -->
	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="<?php echo U('Home/User/login');?>" method="post">
					...
					<!--	<li>
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="submit" value='' name='sub' class="login_btn" />
						</li>
					</ul>
				</form>
			...
			<div class="guide fl">
				...
				<a href="<?php echo U('Home/User/regist');?>" class="reg_btn">免费注册 >></a>
			</div>
