...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京东！[<a href="<?php echo U('Home/User/login');?>">登录</a>] [<a href="<?php echo U('Home/User/regist');?>">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="<?php echo U('Home/User/index');?>"><img src="/Public/home/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<?php if(is_array($res)): foreach($res as $key=>$v): ?><dd><a href=""><?php echo ($v["brand_name"]); ?></a></dd><?php endforeach; endif; ?>
					</dl>
			...
			<?php if(is_array($info)): foreach($info as $key=>$v): ?><ul>
					<li>
						<dl>
							<dt><a href="<?php echo U('Good/showgood',array('good_id'=>$v['good_id']));?>"><img src="<?php echo ($v["good_thumb"]); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('Good/showgood',array('good_id'=>$v['good_id']));?>"><?php echo ($v["good_name"]); ?></a></dt>
							<dd><strong><?php echo ($v["good_price"]); ?></strong></dt>
							<dd><a href="<?php echo U('Good/cart',array('good_id'=>$v['good_id']));?>"><em>加入购物车</em></a></dt>
						</dl>
					</li>
