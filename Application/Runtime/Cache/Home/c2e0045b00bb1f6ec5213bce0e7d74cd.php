	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，<?php echo (session('uname')); ?>欢迎来到京东！</li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
...
<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_info">
					<p>刘航  13888888888 </p>
					<p>江苏 南京市 秦淮区 弓箭坊40号4楼欣才IT学院</p>
				</div>

				<div class="address_select none">
					<ul>
						<li class="cur">
							<input type="radio" name="address" checked="checked" />刘航 江苏省 南京市秦淮区 弓箭坊40号四楼甘池软件 13888888888 
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
						<li>
							<input type="radio" name="address"  />李向阳 江苏省 南京市  秦淮区 弓箭坊40号四楼欣才IT学院 13666666666 
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
					 ...
					 <form action="<?php echo U('Order/success');?>" method="post"  enctype="multipart/form-data">
						<ul>
							<li>
								<label for=""><span>*</span>收 货 人：</label>
								<input type="text" name="get_name" class="txt" />
							</li>
							<li>
								...
								<select name="shr_city" id="">
									<option value="">请选择</option>
									<option value="朝阳区">秦淮区</option>
									<option value="东城区">鼓楼区</option>
									<option value="西城区">玄武区</option>
									<option value="海淀区">栖霞区</option>
									<option value="昌平区">江宁区</option>
								</select>
							...
							<li>
								...
								<input type="text" name="get_phone" class="txt" />
							</li>
						</ul>
					</form>
					 <input class="checkout" type="submit" name="submit" value="保存收货人信息"/>
				</div>
			</div>
			<!-- 收货人信息  end-->
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
					<td class="col1"><a href=""><img src="/thinkroot/<?php echo ($v["good_thumb"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($v["good_name"]); ?></a></strong></td>
					<td class="col2"> <?php echo ($v["good_descript"]); ?> </td>
					<td class="col3">￥<span><?php echo ($v["good_price"]); ?></span></td>
					<td class="col4"><?php echo ($cart); ?></td>	
				</tr><?php endforeach; endif; ?>
                              
			</tbody>
			<tfoot>
				<tr>
					<td colspan="6">购物金额总计： <strong>￥<?php echo ($sprice); ?><span id="total"></span></strong></td>
				</tr>
			</tfoot>
		</table>
		<div class="cart_btn w990 bc mt10">
                        <input type="hidden" name="sprice" value="<?php echo ($sprice); ?>"/>
                        <input type="hidden" name="amount" value="<?php echo ($cart); ?>"/>
               
			 <input class="checkout" type="submit" name="submit" value="提交订单"/>
		</div>
                    </from>
	</div>
	<!-- 主体部分 end -->
	...
	<div class="footer w1210 bc mt15">
		...
		<p class="auth">
			<a href=""><img src="/thinkroot/Public/home/images/xin.png" alt="" /></a>
			<a href=""><img src="/thinkroot/Public/home//kexin.jpg" alt="" /></a>
			<a href=""><img src="/thinkroot/Public/home/images/police.jpg" alt="" /></a>
			<a href=""><img src="/thinkroot/Public/home/images/beian.gif" alt="" /></a>
		</p>
	</div>
	<!-- 底部版权 end -->
</body>
