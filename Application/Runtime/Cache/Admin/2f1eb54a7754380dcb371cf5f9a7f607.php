    ...
    <table class="tables" border="1" width="100%">
           <tr style="font-weight: bold;">
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                ...
                <td><a href="<?php echo U('Admin/Manager/upd',array('manager_id'=>$v['manager_id']));?>">修改</a></td>
                <td><a href="javascript:;" onclick="confirmdel(<?php echo ($v["manager_id"]); ?>)">删除</a></td>
...
function confirmdel(id){
  if(window.confirm('你确定要删除吗？')){
    location.href="<?php echo U('Admin/Manager/del/id/"+id+"');?>";
  }
}
</script>
