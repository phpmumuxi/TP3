...
<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#66cc99" style="margin-bottom:8px;margin-top:8px;">
    <tr>
        <td background="/Public/Admin/images/wbg.gif" bgcolor="#EEF4EA" class="title" colspan="2">
            <span><img src="/Public/Admin/images/arr3.gif" style="margin-right:10px;">修改配置</span>
        </td>
    </tr>
    <tr bgcolor="#FFFFFF">
        <td>
            <table>
                <form action="/index.php/Admin/System/upd" method="post" enctype="multipart/form-data">
				<INPUT type="hidden" name="ts_id" value="<?php echo ($info["ts_id"]); ?>">
                    <tr>
                        <td  width="80px">配置名称:</td>
                        <td>
                            <input type="text" name="ts_name" value="<?php echo ($info["ts_name"]); ?>" placeholder="请输入配置名称"/>
                        </td>
                    </tr>
                    <tr>
                        <td>配置标题:</td>
                        <td>
                            <input type="text" name="ts_title" value="<?php echo ($info["ts_title"]); ?>" placeholder="请输入配置标题"/>
                        </td>
                    </tr>
                    <tr>
                        <td>配置类型:</td>
                        <td>
                            <input type="text" name="ts_type" value="<?php echo ($info["ts_type"]); ?>" placeholder="请输入配置类型">
                        </td>
                    </tr>
                    <tr>
                        <td>
