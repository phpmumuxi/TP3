...
<div style="margin:12px 20px;">
    <table class="tables" border="1" width="100%">
           <tr style="font-weight: bold;">
                <td width="5%">序号</td><td width="10%">权限名称</td>
					 <td width="10%">父级ID</td><td width="10%">控制器</td>
					 <td width="10%">操作方法</td><td width="20%">全路径</td>
					 <td width="10%">等级</td>
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                ...
                <td><a href="<?php echo U('Admin/Auth/upd',array('auth_id'=>$v['auth_id']));?>">修改</a></td>
                <td><a href="javascript:;" onclick="confirmdel(<?php echo ($v["auth_id"]); ?>)">删除</a></td>
...
function confirmdel(id){
  if(window.confirm('你确定要删除吗？')){
    location.href="<?php echo U('Admin/Auth/del/id/"+id+"');?>";
  }
}
</script>
