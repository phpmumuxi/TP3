...
<div style="margin:12px 20px;">
  <div id="tabbar-div">
   ...
   <form method="post" action="/web/Thinks130/index.php/Admin/Good/add" enctype="multipart/form-data">
	     ...
	     <tr style="font-weight:bold;" height="30px">
		      <td >商品品牌：</td><td>
				<select name="brand_id">
					<?php if(is_array($brandinfo)): foreach($brandinfo as $key=>$vv): ?><option value="<?php echo ($vv["brand_id"]); ?>"><?php echo ($vv["brand_name"]); ?></option><?php endforeach; endif; ?>
            </select></td>
        </tr>
        <tr style="font-weight:bold;">
            <td>商品描述：</td>
        ...
        <tr style="font-weight:bold;">
            <td>商品分类：</td><td>
				<select id="" name="cat_id">
					<?php if(is_array($info)): foreach($info as $key=>$vo): ?><option value="<?php echo ($vo["cat_id"]); ?>"><?php echo str_repeat("&nbsp;&nbsp;&nbsp;",$vo['level']); echo ($vo["cat_name"]); ?></option><?php endforeach; endif; ?>
				</select>
        </tr>
    </table>
