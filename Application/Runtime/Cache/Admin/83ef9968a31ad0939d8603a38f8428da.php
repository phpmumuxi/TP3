...
<div style="margin:12px 20px;">
   <form method="post" action="/index.php/Admin/Attribute/add">
    <table border="1" width="100%">
        <tr style="font-weight:bold;">
            <td>属性名称</td><td><input type="text" name="attr_name" /></td>
        </tr>
		  <tr style="font-weight:bold;">
            <td>属性值</td><td><input type="text" name="attr_value" /><font color='red'>多个属性值用","分开</font></td>
        </tr>
		  <tr style="font-weight:bold;">
            <td>所属类型</td><td><select name="type_id">
					<option value="0">-请选择-</option>
					<?php if(is_array($info)): foreach($info as $key=>$vo): ?><option value="<?php echo ($vo["type_id"]); ?>"><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; ?>
            </select>类型必须选择</td>
        </tr>
        <tr>
