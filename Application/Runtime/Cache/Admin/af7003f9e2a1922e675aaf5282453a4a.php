    ...
    <table class="table_a" border="1" width="100%">
        <tbody><tr style="font-weight: bold;">
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                ...
                <td><a href="<?php echo U('Admin/Attribute/showlist',array('type_id'=>$v['type_id']));?>" >属性列表</a></td>
                <td><a href="<?php echo U('Admin/Type/upd',array('id'=>$v['type_id']));?>">修改</a></td>
                <td><a href="javascript:;" onclick="confirmdel(<?php echo ($v["type_id"]); ?>)">删除</a></td>
...
function confirmdel(id){
  if(window.confirm('你确定要删除吗？')){
    location.href="<?php echo U('Admin/Type/del/id/"+id+"');?>";
  }
}
</script>
